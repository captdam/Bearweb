...
class BearAPI_Resource extends BearAPI {
	...
	static async update(data, progress) { // Update a resource, data = {url: "url", category: "category"..., content: Blob("content")}, encode = b64 for base64 encoded content (binary)
		const res = await this.xhr('/api/resource/update', data, progress);
